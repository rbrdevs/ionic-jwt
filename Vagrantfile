...
php_version           = "5.5"    # Options: 5.5 | 5.6 | 7.0 | 7.1
...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "./vagrant", "/vagrant", :mount_options => ["dmode=777", "fmode=777"], fsnotify: true, exclude: ["ionicapp/www"]
